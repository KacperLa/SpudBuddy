...
void ZEDReader::loop() {
    ...
    // sl::Mat image(resolution, 
    //               MAT_TYPE::U8_C4, 
    //               static_cast<sl::uchar1*>(shared_camera_feed.getBuffer()),
    //               resolution.width * 4 * sizeof(sl::uchar1),
    //               sl::MEM::CPU);
    ...
    while (running) {
        ...
        {
            // Get the right frame
            // zed.retrieveImage(image, VIEW::RIGHT, MEM::CPU, resolution);
